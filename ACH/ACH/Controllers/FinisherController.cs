...
{
    public class FinisherController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            HttpResponseMessage response = clinet.GetAsync(clinet.BaseAddress + "/batches/GetReviewedBatches").Result;
        ...
        public ActionResult UpdateBatch(Batch batch)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                return RedirectToAction("Index", "Finisher");
            }
